  ...
  return (
    <StorefrontShell>
      <section className="mx-auto max-w-2xl px-4 pb-16 pt-28 sm:px-6 lg:px-8">
        ...
        <h1 className="mt-4 text-5xl font-black uppercase leading-none sm:text-6xl">Profile settings</h1>
        <form action="/api/account/profile" method="post" className="mt-10 grid gap-4 border border-white/10 p-5">
          <label className="grid gap-1 text-xs font-bold uppercase tracking-[0.12em] text-white/50">
            ...
            <input
              ...
              required
              className="h-12 border border-white/15 bg-transparent px-3 text-white outline-none"
            />
          </label>
          <label className="grid gap-1 text-xs font-bold uppercase tracking-[0.12em] text-white/50">
          ...
          <button className="h-12 bg-white text-sm font-black uppercase tracking-[0.18em] text-black">Save changes</button>
        </form>
      </section>
    </StorefrontShell>
  );

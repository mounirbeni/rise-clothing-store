  ...
  return (
    <StorefrontShell>
      <section className="mx-auto max-w-7xl px-4 pb-12 pt-28 sm:px-6 lg:px-8">
        ...
        <h1 className="mt-4 max-w-5xl text-3xl font-black uppercase leading-none sm:text-4xl lg:text-5xl">
          RISE makes gear for discipline before applause.
        </h1>
        <div className="mt-10 grid gap-8 border-t border-white/10 pt-8 text-base leading-7 text-white/66 lg:grid-cols-2">
          <p>

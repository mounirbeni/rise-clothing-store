      ...
      <section className="relative min-h-[82svh] overflow-hidden pt-16">
        ...
        <div className="relative z-10 mx-auto flex min-h-[82svh] max-w-7xl items-end px-4 pb-14 sm:px-6 lg:px-8">
          <div className="max-w-4xl">
            ...
            <h1 className="mt-4 text-3xl font-black uppercase leading-none sm:text-4xl lg:text-5xl">More Than Yesterday</h1>
            ...
            <Link href="/shop" className="mt-8 inline-flex h-12 items-center rounded-[20px] bg-white px-6 text-sm font-black uppercase tracking-[0.18em] text-black">
              Shop collection
            </Link>
          </div>
        </div>
